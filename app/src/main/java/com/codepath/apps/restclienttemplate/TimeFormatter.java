...
public class TimeFormatter {
    ...
    public static String getTimeStamp(String rawJsonDate) {
        String time = "";
        String twitterFormat = "EEE MMM dd HH:mm:ss ZZZZZ yyyy";
        @SuppressLint({"NewApi", "LocalSuppress"}) SimpleDateFormat format = new SimpleDateFormat(twitterFormat, Locale.ENGLISH);
        ...
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                format1 = new SimpleDateFormat("h:mm a \u00b7 dd MMM yy");
            }
